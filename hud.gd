...
@onready var shield_icon = $MarginContainer/HBoxContainer/TextureRect

var bar_textures = {
	"green": preload("res://assets/assets/bar_green_200.png"),
	"yellow": preload("res://assets/assets/bar_yellow_200.png"),
	"red": preload("res://assets/assets/bar_red_200.png")
}
